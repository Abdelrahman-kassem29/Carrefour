...
class HalwaniPage extends StatefulWidget {
  const HalwaniPage({super.key});

  @override
  _HalwaniPageState createState() => _HalwaniPageState();
}

class _HalwaniPageState extends State<HalwaniPage> {
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 16),
                        Text(
                          'Halwani Beef Burger - 1 kg - 20 Pieces',
                          style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),
                        ),
                        SizedBox(height: 8),
                        Text('183.95', style: TextStyle(fontSize: 20, color: Colors.green)),
                        Text(
                          '281.00',
                          style: TextStyle(
                            fontSize: 20,
